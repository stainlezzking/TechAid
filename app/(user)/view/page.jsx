  ...
  return (
    <div className="mx-[31px]">
      <div className="mx-auto pt-[74px] pb-[43px] xl:max-w-[1200px]">
        <div className="border-b border-black w-full ">Can't Receive or Send Email</div>
        <div className="flex justify-between py-[15px]">
          ...
          <div className="flex flex-col gap-[24px]">
            <div className="flex flex-col">
              ...
              <span>
                I have not been able to send and <br /> receive emails since yesterday
              </span>
            </div>
            <div className="flex flex-col">
              <span>
                Can you help me check what is <br /> happening?
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="py-[18px]">
          <Button className="p-[12px] w-[20%] ml-auto" onClick={addMessage}>
            Add Message
          </Button>
        </div>
