    ...
    <div className="mx-[31px]">
      ...
      <div className="p-[50px] xl:max-w-[1200px] mx-auto">
        ...
        <div className="flex gap-8 pb-[30px]">
          <Box className="grow shrink-0 aspect-[1] max-h-[200px] p-[20px]">
            Tickets Raised <p className="font-bold text-2xl py-[3px]">10</p>
          </Box>
          <Box className="grow shrink-0 aspect-[1] max-h-[200px] p-[20px]">
            Closed <p className="font-bold text-2xl py-[3px]">7</p>
          </Box>
          <Box className="grow shrink-0 aspect-[1] max-h-[200px] p-[20px]">
            Not Assigned <p className="font-bold text-2xl py-[3px]">1</p>
          </Box>
          <Box className="grow shrink-0 aspect-[1] max-h-[200px] p-[20px]">
            {" "}
            In Progress <p className="font-bold text-2xl py-[3px]">2</p>
          </Box>
        </div>
          ...
          <Box className="grow shrink-0 aspect-[1] max-h-[160px] px-[9px] py-[19px] text-sm">
            <Link href="/view">
              <div className="flex items-center justify-between pb-[2px]">
                ...
                <div className="border border-[#4AF117] rounded-xl p-[15px]">Open</div>
              </div>
          ...
          <Box className=" grow shrink-0 aspect-[1] max-h-[160px] px-[9px] py-[19px] text-sm">
            <Link href="/view">
              <div className="flex items-center justify-between pb-[10px]">
                ...
                <div className="border border-[#FF0000] rounded-xl p-[15px]">Overdue</div>
              </div>
              <div className="flex flex-row justify-between font-light px-[31px] pb-[3px]">
                <span>Submitted</span>
                <span>Priority</span>
          ...
          <Box className="grow shrink-0 aspect-[1] max-h-[160px] px-[9px] py-[19px] text-sm">
            <Link href="/view">
              <div className="flex items-center justify-between pb-[10px]">
                ...
                <div className="border border-primaryBlue rounded-xl p-[15px]">Not Assigned</div>
              </div>
              <div className="flex flex-row justify-between font-light px-[31px] pb-[3px]">
                <span>Submitted</span>
                <span>Priority</span>
          ...
          <Box className="grow shrink-0 aspect-[1] max-h-[160px] px-[9px] py-[19px] text-sm">
            <Link href="/view">
              <div className="flex items-center justify-between pb-[10px]">
                ...
                <div className="border border-black rounded-xl p-[15px]">Closed</div>
              </div>
              <div className="flex flex-row justify-between font-light px-[31px] pb-[3px]">
                <span>Submitted</span>
                <span>Priority</span>
