    ...
    <div className="mx-[31px]">
      ...
      <div className="mx-auto pt-[104px] xl:max-w-[1200px]">
        ...
        <div className="py-[31px]">
          When users encounter problems signing in, it is important to systematically eliminate potential causes. Start by confirming that the credentials
          entered are correct. Common issues includeincorrect passwords, browser caching problems, and intermittent network errors.
        </div>
