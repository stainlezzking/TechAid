  ...
  return (
    <div className="mx-auto xl:max-w-[1200px]">
      ...
      <div className="py-[31px]">
        When users encounter problems signing in, it is important to systematically eliminate potential causes. Start by confirming that the
        credentials entered are correct. Common issues includeincorrect passwords, browser caching problems, and intermittent network errors.
      </div>
      ...
      <div>
        <ul className="ml-[20px] list-disc">
          ...
          <li>
            ...
            <span>
              Confirm that your internet connection is stable; if you are using Wi-Fi, try switching to a wired connection or restarting your router.
            </span>
          </li>
        </ul>
      </div>
