...
const TechHome = function () {
  ...
  const surveyData = [
    {
      id: "25021",
      name: "Gabriel Olayiwola",
      description: "Shared mailbox is missing",
      status: "closed",
      dateClosed: "2025-02-11",
      ratings: "★★★★★",
    },
    {
      id: "25012",
    ...
    <div className="mx-[31px]">
      <div className="p-[50px] pb-[58px] xl:max-w-[1200px] mx-auto">
        <div className="flex justify-between pb-[33px]">
          <select className="text-xl font-medium" value={isSurvey ? "Survey" : "Engineer"} onChange={(e) => setIsSurvey(e.target.value === "Survey")}>
        ...
        <div>
          <Table headers={headers} data={data} rowsPerPage={rowsPerPage} currentPage={currentPage} view={false}></Table>
        </div>
